...
void main() {
  test(
    ...
    () => fail(
      "Dart port not implemented: tests.test_kg.KGTest.test_nothing_about_a_person_before_they_enter",
    ),
    skip:
  ...
  test(
    ...
    () => fail(
      "Dart port not implemented: tests.test_kg.KGTest.test_early_events_belong_to_the_identity_the_reader_knows",
    ),
    skip:
  ...
  test(
    ...
    () => fail(
      "Dart port not implemented: tests.test_kg.KGTest.test_revealed_name_not_used_before_the_reveal",
    ),
    skip:
  ...
  test(
    ...
    () => fail(
      "Dart port not implemented: tests.test_kg.KGTest.test_merge_links_the_two_records",
    ),
    skip:
  ...
  test(
    ...
    () => fail(
      "Dart port not implemented: tests.test_kg.KGTest.test_generic_title_needs_a_decision",
    ),
    skip:
  ...
  test(
    ...
    () => fail(
      "Dart port not implemented: tests.test_kg.KGTest.test_mentions_are_positioned_on_the_text",
    ),
    skip:
  ...
  test(
    ...
    () => fail(
      "Dart port not implemented: tests.test_kg.TextTest.test_generic_reveal_keeps_old_label_only_before_the_reveal",
    ),
    skip:
